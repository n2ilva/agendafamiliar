...
export const AuthProvider = ({ children }) => {
    ...
    try {
      ...
      if (googleCredential) {
        try {
          ...
          // Tenta registrar token de push Expo (se permitido e disponível)
  ...
  const signUpWithEmail = async (email, password, displayName) => {
    try {
      const firebaseUser = await firebaseService.signUpWithEmail(email, password);
      console.log('Cadastro com e-mail realizado com sucesso');
